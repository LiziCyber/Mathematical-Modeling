    ...
    for j=1:b
        if P(3).jud(i,j,1)
            ...
            t3=T(1).mit(...
                ...
                pos(2).y(temp2),...
                temp3);
            Tt(3).t(i,j)=t1+t2+t3+delta(3).time(temp1)+delta(2).time(temp2);
        else
            Tt(3).t(i,j)=NaN;
        end
    end
    ...
    for j=1:b
        if P(2).jud(i,j,1)
            ...
            t2=T(2).mit(...
                ...
                pos(2).y(temp1),...
                temp2);
                Tt(2).t(i,j)=t1+t2+delta(2).time(temp1);
        else
            Tt(2).t(i,j)=NaN;
        end
    end
    ...
    for j=1:b
        if P(5).jud(i,j,1)
            ...
            t3=T(1).mit(...
                ...
                pos(4).y(temp2),...
                temp3);
            Tt(5).t(i,j)=t1+t2+t3+delta(5).time(temp1)+delta(4).time(temp2);
        else
            Tt(5).t(i,j)=NaN;
        end
    end
    ...
    for j=1:b
        if P(2).jud(i,j,1)
            ...
            t2=T(1).mit(...
                ...
                pos(4).y(temp1),...
                temp2);
                Tt(4).t(i,j)=t1+t2+delta(4).time(temp1);
        else
            Tt(4).t(i,j)=NaN;
        end
    end
...
m0=min(min([Tt(1:5).t]));
for i=1:c
    [Tp(i).x,Tp(i).y]=find((Tt(i).t>=m0+200)&(Tt(i).t<=m0+210));
end
...
fid=fopen('ans00blocks315.txt','a');
for i=1:num(1)
